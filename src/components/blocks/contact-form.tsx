...
export function ContactForm() {
  ...
  const formAction = useAction(serverAction, {
    ...
    onError: () => {
      // swallow errors silently; UI surfaces via RHF
    },
  })
  ...
  if (hasSucceeded) {
    return (
      <div className="w-full gap-2 rounded-md border p-2 sm:p-5 md:p-8">
        <div className="success-pop-in h-full px-3 py-6">
          <div className="success-check-pop mx-auto mb-4 flex w-fit justify-center rounded-full border p-2">
